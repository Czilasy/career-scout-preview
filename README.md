# Career Scout v1.7.10 · BOSS直聘 & 智联招聘职位助手
...
- 顶栏设置菜单收纳 AI 设置、浏览器账号、环境检查、更新检查与 GitHub 仓库；结果页平台名与已判定数始终来自同一查看范围。
...
- **求职画像事实化**：简历分析产出的求职画像为 3-5 句事实清单（工作年限、学历、期望城市/薪资、技能、项目），可编辑；精筛对照学历、经验、技能等硬性条件判断，简历未体现的维度不推断。
