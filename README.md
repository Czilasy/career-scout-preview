# Career Scout v1.8.0 · BOSS直聘 & 智联招聘职位助手
...
- 最新正式版：v1.8.0
- Windows 安装包：`CareerScout-v1.8.0.exe`，下载后双击运行
- macOS 安装包：`CareerScout-v1.8.0.dmg`，首次打开见下方 Gatekeeper 说明
...
- 顶栏设置菜单收纳 AI 设置、浏览器账号、环境检查、日志、更新检查与 GitHub 仓库；结果页平台名与已判定数始终来自同一查看范围。
