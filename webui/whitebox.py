...
class WhiteboxService:
    _EVENT_TYPES = {'task_started', 'task_paused', 'stage_started', 'unit_started', 'page_started', 'page_completed', 'scope_completed', 'source_exhausted', 'explicit_empty', 'unit_failed', 'unit_incomplete', 'unit_skipped', 'account_switched', 'account_switch', 'account_pool_snapshot', 'account_allocation', 'account_handoff', 'browser_restarted', 'browser_recovered', 'stall_detected', 'retry_started', 'retry_abandoned', 'retry_scheduled', 'ai_request_failed', 'ai_keep_all_fallback', 'checkpoint_restored', 'recovery_completed', 'submission_failed', 'whitebox_incomplete', 'emergency_record_imported', 'task_finalized', 'task_interrupted'}
